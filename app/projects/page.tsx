...
const projects: ProjectItemProps[] = [
  {
    name: "Hola",
    url: "https://hola-fvhk.onrender.com/",
    image: "/images/Hola.svg",
...
function ProjectItem(props: ProjectItemProps) {
  let { name, url, image, repo } = props;
  return (
    <li key={url}>
      <div className="max-w-sm rounded overflow-hidden shadow-lg">
        <Link href={url} target="_blank">
          <div className="hover:opacity-80 transition-opacity duration-300 ease-in-out w-fit h-32 overflow-hidden">
            <Image
              src={image}
              alt={name}
              width={0}
